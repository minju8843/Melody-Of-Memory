   ...
   // public GameObject[] Main_False;//비활성해야 할 것
    ...
    public void Update()
    {
        ...
        for (int i = 0; i < Pause_Black.Length; i++)
        {
            ...
            //퍼즈 창이 열려있는 경우 + 결과창 비활성 + 리듬게임 실행중
            ...
            //퍼즈 창이 닫혀있는 경우 + 결과창 안 보임 + 리듬게임 실행중
    ...
    public void ReStart_True()
    {
        ...
        IEnumerator Go_Game()
        {
            ...
            manager[0].Result_Panel.SetActive(false);//결과창 보이지 않도록
    ...
    //Win_4_Note
            ...
            //타이머
            //Winter_Music_Audio[0].time = 0;//퍼즈 시간 초기화
            //Winter_Music_Obj[0].SetActive(true);//윈터 0번째 음악 리듬게임 활성
    ...
    private void Music_Go()
    {
        ...
        //yield return new WaitForSecondsRealtime(11.1f);//5초보다는 크고
        Winter_Music_Audio[0].time = 0;//퍼즈 시간 초기화
        Winter_Music_Obj[0].SetActive(true);//윈터 0번째 음악 리듬게임 활성
